sap.ui.define([], function() {
	...
	return {
		...
		/**
		 * Grouping function to group the master list by Freight
		 * @public
		 * @param {object} oContext the current list item context
		 * @returns {object} an object with the Freight as key and a text for the group headers
		 */
		Freight: function(oContext) {
			var iPrice = oContext.getProperty("Freight"),
				sKey,
				sText,
